...
function ColorPalette() {
  return (
    <div className="space-y-6 pt-6">
      <h3 className="font-medium text-2xl">Color Palette</h3>
      <p className="text-lg">
      ...
      <div className="grid grid-cols-6 gap-12">
        <div className="bg-white border-[#8E8E8E] h-[250px] col-span-2 border-[1px] pt-4">
          <span className="text-base pt-4 pl-6 block">White</span>
          <span className="text-base pt-4 pl-6 block text-[#828080]">
            Primary Background Color
          </span>
        </div>
        <div className="border-[#8E8E8E] h-[250px] col-span-2 border-[1px]">
