...
function LetsTalk({ children }: { children: React.ReactNode }) {
  return (
    ...
    lg:pt-48 md:pt-52 mobilemd:pt-52 px-24 mobilemd:px-4 
    xl:space-y-7 lg:space-y-4 md:space-y-3 mobilemd:space-y-4"
    >
      <h3
        className="text-[#161616] font-medium text-center leading-none
      desktop:text-[15rem] xl:text-[11rem] lg:text-[10rem] md:text-[9rem] mobilemd:text-[8rem] ml-[-8px] 
      "
      >
        LET&apos;S TALK!
      </h3>
